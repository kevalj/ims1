<div id="page-wrapper" class="load_form">
			<div class="main-page">
				<div class="forms">
					...
					<div class="row">
						<h3 class="title1">View Planned Load :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/load/editLoad">
							...
							<div class="panel-body"> 
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-3 control-label">Upload Document1</label>
									<!--<div class="col-sm-3">
										<input type="file" name="document1" id="document1" size="20" />
										</div>
										<div class="col-sm-3">

										<input type="button" name="upload1" id="upload1" value="Upload" class="btn btn-info"/>
								    </div>-->

									<?php foreach($result3 as $data): ?>
									

										<?php if($data['load_doc_type_id']==1){ ?>
										<div class="col-sm-3">
										<a href ="<?php echo base_url().'upload/'.$data['document_file_name']; ?>" target="_blank" ><?php echo $data['document_file_name'] ;?></a>
										</div>
										<?php } ?>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-3 control-label">Upload Document2</label>
									<!--<div class="col-sm-3">
										<input type="file" name="document2" id="document2" size="20" />
										</div>
										<div class="col-sm-3">

										<input type="button" name="upload2" id="upload2" value="Upload" class="btn btn-info"/>
								    </div>-->
									<?php foreach($result3 as $data): ?>
									
										<?php if($data['load_doc_type_id']==2){ ?>
										<div class="col-sm-3">
										<a href="<?php echo base_url().'upload/'.$data['document_file_name']; ?>" target="_blank" ><?php echo $data['document_file_name'] ;?></a>
										</div>
										<?php } ?>
								...
								<div class="form-group">
									...
									<div class="panel-heading" id='divh_<?php echo $i+1;?>'> 
									<h3 class="panel-title">Pickup - <?php echo $i+1;?></h3> 
									</div> 

									<div class="panel-body"> 
									<div class="col-sm-12 element" id='div_<?php echo $i+1;?>'>
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 shipper_name" id="shipper_name<?php echo $i+1;?>" name="shipper_name[]" placeholder="Enter Shipper Name" value="<?php echo $data['customer_name'] ?>">
										<input type="hidden" class="form-control1 shipper_name" id="shipper_id<?php echo $i+1;?>" name="shipper_id[]" placeholder="Enter Shipper Name" value="<?php echo $data['shipper_id'] ?>">
										</div>
										<!--<div class="col-sm-2">
										<a class="btn btn-primary btn-flat btn-pri btn-lg" onclick="show_cust_form('shipper_name<?php echo $i+1;?>','shipper_id<?php echo $i+1;?>')"><i class="fa fa-plus" aria-hidden="true"></i>Shipper</a>
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 pickup_date" id="pickup_date<?php echo $i+1;?>" name="pickup_date[]" placeholder="Enter Pickup Date" readonly value="<?php echo $data['pickup_date'] ?>">
										</div>
										</div>
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 instructions" id="instructions<?php echo $i+1;?>" name="instructions[]" placeholder="Enter Instructions" value="<?php echo $data['instructions'] ?>">
										</div>
										</div>
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 bol" id="bol<?php echo $i+1;?>" name="bol[]" placeholder="Enter BOL" value="<?php echo $data['bol'] ?>" >
										</div>
										</div>
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 cust_req_info" id="cust_req_info<?php echo $i+1;?>" name="cust_req_info[]" placeholder="Enter Customer Required Info" value="<?php echo $data['customer_req_info'] ?>">
										</div>
										</div>
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 weight" id="weight<?php echo $i+1;?>" name="weight[]" placeholder="Enter Weight" value="<?php echo $data['weight'] ?>" onblur="formatno(this.value,'weight<?php echo $i+1;?>')">
										</div>
										</div>
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 quantity" id="quantity<?php echo $i+1;?>" name="quantity[]" placeholder="Enter Quantity" value="<?php echo $data['quantity'] ?>" onblur="formatno(this.value,'quantity<?php echo $i+1;?>')">
										</div>
										<div class="col-sm-4">
										<select class="form-control1" id="quantity_type<?php echo $i+1;?>" name="quantity_type[]" id="planned_load_planned_load_waypoints_shippers_attributes__quantity_type">
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 notes" id="notes<?php echo $i+1;?>" name="notes[]" placeholder="Enter Notes" value="<?php echo $data['notes'] ?>">
										</div>
										</div>
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 commodity" id="commodity<?php echo $i+1;?>" name="commodity[]" placeholder="Enter Commodity" value="<?php echo $data['commodity'] ?>">
										</div>
										</div>
									...
									<?php endforeach; ?>
									<input type="hidden" name="picincid" id="picincid" value="<?php echo $i;?>">
								    </div>
									...
									<div class="panel-heading" id='delh_<?php echo $j+1;?>'> 
									<h3 class="panel-title">Delivery - <?php echo $j+1;?></h3> 
									</div> 
									<div class="panel-body">
									<div class="col-sm-12 element1" id='del_<?php echo $j+1;?>'>

										
										<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Consignee </label>
										<div class="col-sm-6">
										<input type="text" class="form-control1 consignee_name" id="consignee_name<?php echo $j+1;?>" name="consignee_name[]" placeholder="Enter Consignee" value="<?php echo $data['customer_name'] ?>">
										<input type="hidden" class="form-control1 consignee_name" id="consignee_id<?php echo $j+1;?>" name="consignee_id[]" placeholder="Enter Shipper Name"  value="<?php echo $data['cosignee_id'] ?>">
										</div>
										<!--<div class="col-sm-2">
										<a class="btn btn-primary btn-flat btn-pri btn-lg"  onclick="show_cust_form('consignee_name<?php echo $i+1;?>','consignee_id<?php echo $i+1;?>')"><i class="fa fa-plus" aria-hidden="true"></i>Consignee</a>
										...
										<div class="col-sm-6">
										<input type="text" class="form-control1 delivery_date" id="delivery_date<?php echo $j+1;?>" name="delivery_date[]" placeholder="Enter Delivery Date" readonly value="<?php echo $data['delivery_date'] ?>">
										</div>
										</div>
										...
										<label for="focusedinput" class="col-sm-2 control-label">Instructions</label>
										<div class="col-sm-6">
										<input type="text" class="form-control1 instructions" id="instructions<?php echo $j+1;?>" name="instructions[]" placeholder="Enter Instructions" value="<?php echo $data['instruction'] ?>">
										</div>
										</div>
										</div>
										<?php $j++;?>
								...
								<?php foreach($result as $data): ?>
								<input type="hidden" id="delincid" name="delincid" value="<?php echo $j;?>">
								<div class="panel panel-info">
								...
								<div class="form-group">
									...
									<div class="panel-body"> 
										...
										<div class="col-sm-4">
										<input type="text" class="form-control1" id="primary_fee" name="primary_fee" placeholder="Enter Primary Fee" value="<?php echo $data['primary_fee'] ?>" onblur="formatno(this.value,'primary_fee')">
										</div>
									...
									<div class="panel-body"> 
										...
										<div class="col-sm-4">
										<input type="text" class="form-control1" id="fsc_amt" name="fsc_amt" placeholder="Enter FSC Amount" value="<?php echo $data['fsc_amount'] ?>" onblur="formatno(this.value,'fsc_amt')">
										</div>
										</div>
										...
										<?php foreach($fsc_amount_type as $data1): ?>
											<?php $selected="";?>
											  ...
											  if($data['fsc_amount_type']==$data1['fsc_amount_type_id']){
											   ...
											   ?>
											<option value="<?php echo $data1['fsc_amount_type_id'] ?>" <?php echo $selected; ?>>
											<?php echo $data1['fsc_amount_type'] ?></option>
									...
									<div class="panel-body"> 
										...
										<div class="col-sm-4">
										<input type="text" class="form-control1" id="additional" name="additional" placeholder="Enter Additional " value="<?php echo $data['additional'] ?>" onblur="formatno(this.value,'additional')">
										</div>
										...
										<div class="col-sm-4">
										<input type="text" class="form-control1" id="detention" name="detention" placeholder="Enter Detention" value="<?php echo $data['detention'] ?>" onblur="formatno(this.value,'detention')">
										</div>
										</div>
										...
										<div class="col-sm-4">
										<input type="text" class="form-control1" id="lumper" name="lumper" placeholder="Enter Lumper" value="<?php echo $data['lumper'] ?>" onblur="formatno(this.value,'lumper')">
										</div>
										</div>
										...
										<div class="col-sm-4">
										<input type="text" class="form-control1" id="stop_off" name="stop_off" placeholder="Enter Stop Off" value="<?php echo $data['stop_off'] ?>" onblur="formatno(this.value,'stop_off')">
										</div>
										</div>
										...
										<div class="col-sm-4">
										<input type="text" class="form-control1" id="tarp_fee" name="tarp_fee" placeholder="Enter Tarp Fee" value="<?php echo $data['tarp_fee'] ?>" onblur="formatno(this.value,'tarp_fee')">
										</div>
										</div>
										</div>
										</div>
									...
									<div class="panel-body"> 
										...
										<div class="col-sm-8">
										<input type="text" class="form-control1" id="invoice_adv" name="invoice_adv" placeholder="Enter Invoice Advance" value="<?php echo $data['invoice_addvance'] ?>" onblur="formatno(this.value,'invoice_adv')">
										</div>
										</div>
										</div>
										</div>
								...
								<div class="form-group col-sm-2">
										...
										<input type="hidden" class="form-control1" name="loading_id" id="loading_id" value="<?php echo $data['loading_id'] ?>" placeholder="Default Input">
									</div>
								</div>
								</div>
...
//alert(nextindex1);
  ...
  var nextindex = Number(split_id[1]) + 1;
   ...
   //alert(document.getElementById('del_1'));
										...
										div=div+'</div>';
										div=div+'<div class="col-sm-4">';
										div=div+'<a class="btn btn-primary btn-flat btn-pri btn-lg" onclick="show_cust_form(\'consignee_name'+pickupid+'\',\'consignee_id'+pickupid+'\')"><i class="fa fa-plus" aria-hidden="true"></i>Consignee</a>';
  ...
  function getRate(){
	var driver_count = $("#driver_count").val();
	  ...
	  $('#upload1').click(function(e){
    		...
    		reader.readAsDataURL(document.getElementById('document1').files[0]);
 
			var formdata = new FormData();
			formdata.append('file', document.getElementById('document1').files[0]);
			formdata.append('type', '1');
			formdata.append('loadid', $("#loading_id").val());
			$.ajax({
				method: 'POST',
				contentType: false,
			    cache: false,
				...
				url: url + 'index.php/load/uploaddoc',
		 ...
		 $('#upload2').click(function(e){
			...
			var reader = new FileReader();
    		reader.readAsDataURL(document.getElementById('document2').files[0]);
 
			var formdata = new FormData();
			formdata.append('file', document.getElementById('document2').files[0]);
