...
<div class="row">
						...
						<div class="form-three widget-shadow">
							<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/InventoryTransfer/depot_to_service_center_add">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
									<label for="focusedinput" class=" control-label"><b>Service Center</b></label>
								    </div>

									<div class="col-sm-2">
									<label for="focusedinput" class=" control-label"><b>Machine Part Type</b></label>
								    </div>
									...
									<div class="col-sm-1">
									<label for="focusedinput" class=" control-label"><b>Return Count</b></label>
								    </div>
								...
								<a href="<?php echo base_url(); ?>index.php/InventoryTransfer/view_service_center_inventory" class="btn btn-info">Cancel</a>
								   ...
								   div=div+'<div class="col-sm-2">';
									...
									div=div+'<option value="0">Select</option>';
											<?php foreach($depot as $data1): ?>
											 div=div+'<option value="<?php echo $data1['depotId'] ?>"><?php echo $data1['depot_name'] ?></option>';
											<?php endforeach; ?>
...
$("select").chosen();
			...
			function getDepotData(id){
				//alert(id)
						...
						$.ajax({
							type: "POST",
							url: '<?php echo base_url(); ?>index.php/InventoryTransfer/getDepotInventory',
							data: postData,
