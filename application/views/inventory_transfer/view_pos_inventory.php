...
<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1">View POS Inventory</h2>
					<a href="<?php echo base_url(); ?>index.php/InventoryTransfer/pos_inventory" class="btn btn-primary">Add POS Inventory</a>
					...
					function servicecenter(){
						...
						//alert(id);
						location.href = "<?php echo base_url(); ?>index.php/InventoryTransfer/posToServiCecenter?id="+id;
