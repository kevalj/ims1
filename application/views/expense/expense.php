<div id="page-wrapper" class="expenseform">
			<div class="main-page">
				<div class="forms">
<div class="row">
						<h3 class="title1">Add an Expense  :</h3>
						<div class="form-three widget-shadow">
							<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/expense/expenseadd">

							
							<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Expense Date</label>
									<div class="col-sm-4">
										<input type="text" class="form-control1" id="expense_date" name="expense_date" placeholder="Enter Expense Date" readonly>
								    </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control1" id="fuel_vendor" name="fuel_vendor" placeholder="Enter Fuel Vendor">
										<input type="hidden" class="form-control1" id="fuel_vendor_id" name="fuel_vendor_id" placeholder="Enter Fuel Vendor">
								    </div>
									<div class="col-sm-2">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control1" id="amount" name="amount" placeholder="Enter Amount" onblur="formatno(this.value,'amount')">
								    </div>
	                            ...
	                            <div class="form-group">
									...
									<div class="col-sm-4">
									<input type="text" class="form-control1" id="truck" name="truck" placeholder="Enter Truck No">
									<input type="hidden" class="form-control1" id="truck_id" name="truck_id" placeholder="Enter Truck No">
									</div>
									<div class="col-sm-3">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control1" id="description" name="description" placeholder="Enter Description">
								    </div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control1" id="gallons" name="gallons" placeholder="Enter Gallons">
								    </div>
