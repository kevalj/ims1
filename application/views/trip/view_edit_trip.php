...
<div id="page-wrapper" class="trip_form">
			<div class="main-page">
				<div class="forms">
<div class="row">
						<h3 class="title1">View a Trip  :</h3>
						<div class="form-three widget-shadow">
							...
							<div class="panel-body"> 
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
									<!--<a class="btn btn-primary btn-flat btn-pri btn-lg" onclick="show_driver_form('driver','driver_id')"><i class="fa fa-plus" aria-hidden="true"></i>Driver</a>-->
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
									<!--<a class="btn btn-primary btn-flat btn-pri btn-lg" onclick="show_driver_form('team_driver','team_driver_id')"><i class="fa fa-plus" aria-hidden="true"></i>Team Driver</a>-->
									</div>
							...
							<div class="panel-body"> 
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
									<!--<a class="btn btn-primary btn-flat btn-pri btn-lg" onclick="show_vehicle_form('truck','truck_id')"><i class="fa fa-plus" aria-hidden="true"></i>Truck</a>-->
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
									<!--<a class="btn btn-primary btn-flat btn-pri btn-lg" onclick="show_vehicle_form('trailer','trailer_id')"><i class="fa fa-plus" aria-hidden="true"></i>Trailer</a>-->
									</div>
							...
							<div class="panel-body"> 
									...
									<div class="col-sm-6">
									<input type="text" class="form-control1 delivery_date hasDatepicker" id="delivery_date<?php echo $i+1;?>" name="delivery_date[]" placeholder="Enter Delivery Date" readonly="" value="<?php echo $data['routing_stop_date'] ?>">
									</div>
									</div>
									<div class="form-group">
								...
								<div class="panel-body"> 
									...
									<div class="col-sm-6">
									<input type="text" class="form-control1 delivery_date hasDatepicker" id="expense_date<?php echo $j+1;?>" name="expense_date[]" placeholder="Enter Expense Date" readonly="" value="<?php echo $data['expense_date'] ?>">
									</div>
									</div>
									<div class="form-group">
								...
								<div class="panel-body"> 
									...
									<?php foreach($result2 as $data1): ?>
										<option value="<?php echo $data1['expense_details_id'] ?>" ><?php echo $data1['expense_name'] ?></option>;
											<?php endforeach; ?>
									</select>
									</div>
									<div class="col-sm-2">
									<!--<a class="btn btn-primary btn-flat btn-pri btn-lg" href="javascript:window.open('http://localhost:82/truckmgmt//index.php/master/customer?id=exp_category<?php echo ($k+1)?>&amp;id1=exp_category_id<?php echo ($k+1)?>','mypopuptitle','width=600,height=400')"><i class="fa fa-plus" aria-hidden="true"></i> Expense Category</a>-->
									</div>
									</div>
									<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Expense Date</label>
									<div class="col-sm-6">
									<input type="text" class="form-control1 expense_date hasDatepicker" id="truck_expense_date<?php echo ($k+1)?>" name="truck_expense_date[]" placeholder="Enter Expense Date" readonly="" value="<?php echo $data['expense_date'] ?>">
									</div>
									</div>
									<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Amount</label>
								...
								<div class="panel-body"> 
									...
									<label for="focusedinput" class="col-sm-2 control-label">Expense Date</label>
									<div class="col-sm-6">
									<input type="text" class="form-control1 ref_delivery_date hasDatepicker" id="ref_expense_date<?php echo $l+1;?>" name="ref_expense_date[]" placeholder="Enter Expense Date" readonly="" value="<?php echo $data['expense_date'] ?>">
									</div>
									</div>
									<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Amount</label>
								...
								<!--<div class="form-group">
									<button type="button" class="btn btn-primary btn-flat btn-pri btn-lg" onclick="addreffuelexp()"><i class="fa fa-plus" aria-hidden="true"></i> Reefer Fuel Expenses</button>
...
$("#routingstop").css('display','block');
   ...
   $(".element1:last").after("<div class='element1' id='del_"+ nextindex1 +"'></div>");
										...
										var div='<div class="panel-heading"> <h3 class="panel-title">Routing Stop - '+(nextindex1+1)+'</h3> </div><div class="panel-body"><div class="form-group">';
										...
										div=div+'<a class="btn btn-primary btn-flat btn-pri btn-lg" onclick="show_cust_form(\'customer_name'+nextindex1+'\',\'customer_id'+nextindex1+'\')"><i class="fa fa-plus" aria-hidden="true"></i>Routing Stop</a>';
...
$("#fuelexpense").css('display','block');
	  $(".element2:last").after("<div class='element2' id='del1_"+ nextindex2 +"'></div>");
										...
										div=div+'<div class="panel-heading"> <h3 class="panel-title">Fuel Expense - '+(nextindex2+1)+'</h3> </div><div class="panel-body"><div class="form-group">';
...
var nextindex3=parseInt($("#fueltruckid").val())+1;
  function addtruckexp(){
	  ...
	  $(".element3:last").after("<div class='element3' id='del2_"+ nextindex3 +"'></div>");
										...
										div=div+'<div class="panel-heading"> <h3 class="panel-title">Truck Expense - '+(nextindex3+1)+'</h3> </div><div class="panel-body"><div class="form-group">';
										...
										<?php foreach($result2 as $data1): ?>
										div=div+'	<option value="<?php echo $data1['expense_details_id'] ?>" ><?php echo $data1['expense_name'] ?></option>';
											<?php endforeach; ?>
										div=div+'</select>';
										div=div+'</div>';
										div=div+'<div class="col-sm-2">';
										div=div+'<a class="btn btn-primary btn-flat btn-pri btn-lg" href="javascript:window.open(\'<?php echo base_url(); ?>/index.php/master/customer?id=exp_category'+nextindex3+'&id1=exp_category_id'+nextindex3+'\',\'mypopuptitle\',\'width=600,height=400\')"><i class="fa fa-plus" aria-hidden="true"></i> Expense Category</a>';
...
var nextindex4=parseInt($("#reeferfuelid").val())+1;
  function addreffuelexp(){
	  ...
	  $(".element4:last").after("<div class='element4' id='del3_"+ nextindex4 +"'></div>");
										...
										div=div+'<div class="panel-heading"> <h3 class="panel-title">Refer Fuel Expense - '+(nextindex4+1)+'</h3> </div><div class="panel-body"><div class="form-group">';
										div=div+'<label for="focusedinput" class="col-sm-2 control-label">Expense Date</label>';
										div=div+'<div class="col-sm-6">';
