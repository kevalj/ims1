...
<div id="page-wrapper" class="trip_form">
			<div class="main-page">
				<div class="forms">
<div class="row">
						<h3 class="title1">Add a Trip  :</h3>
						<div class="form-three widget-shadow">
							<form action="<?php echo base_url(); ?>index.php/trip/tripadd" class="form-horizontal" method="post">
							...
							<div class="panel-body"> 
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="cust_trip_no" name="cust_trip_no" placeholder="Enter Custom Trip Number">
								    </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="trip_tracking_link" name="trip_tracking_link" placeholder="Enter Trip Tracking Link">
								    </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="driver" name="driver" placeholder="Enter Driver Name">
										<input type="hidden" class="form-control1" id="driver_id" name="driver_id" placeholder="Enter Driver Name">
								    </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="acc_driver_pay" name="acc_driver_pay" placeholder="Enter Accessory Driver Pay" onblur="formatno(this.value,'acc_driver_pay')">
								    </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="driver_advance" name="driver_advance" placeholder="Enter Driver Advance" onblur="formatno(this.value,'driver_advance')">
								    </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="team_driver" name="team_driver" placeholder="Enter Team Driver">
										<input type="hidden" class="form-control1" id="team_driver_id" name="team_driver_id" placeholder="Enter Team Driver">
								    </div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Accessory Driver Pay</label>
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="acc_team_driver_pay" name="acc_team_driver_pay" placeholder="Enter Accessory Driver Pay" onblur="formatno(this.value,'acc_team_driver_pay')">
								    </div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Driver Advance</label>
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="team_driver_advance" name="team_driver_advance" placeholder="Enter Team Driver" onblur="formatno(this.value,'team_driver_advance')">
								    </div>
							...
							<div class="panel-body"> 
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="truck" name="truck" placeholder="Enter truck" >
										<input type="hidden" class="form-control1" id="truck_id" name="truck_id" placeholder="Enter truck" >
								    </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="trailer" name="trailer" placeholder="Enter trailer">
										<input type="hidden" class="form-control1" id="trailer_id" name="trailer_id" placeholder="Enter trailer">
								    </div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control1" id="odometer1" name="odometer1" placeholder="Enter odometer">
								    </div>
							...
							<div class="panel-body"> 
								...
								<div class="form-group element1" id="routingstop" style="display:none">
								<div class="panel panel-info">
								<div class="panel-heading">
							...
							<div class="panel-body"> 
								...
								<div class="form-group element2"  id="fuelexpense" style="display:none">
								...
								<div class="form-group element3" id="truckexpense" style="display:none">
								<div class="panel panel-info">
								<div class="panel-heading">
								...
								<div class="form-group element4" id="reffuelexpense" style="display:none">
								<div class="panel panel-info">
								<div class="panel-heading">
...
<script>
					...
					"pageLength" : 10,
					"ajax": {
						url : "<?php echo base_url(); ?>index.php/load/getTripLoadData",
						type : 'POST'
					},
				});
