...
<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1">View Region</h2>
					<a href="<?php echo base_url(); ?>index.php/master/project" class="btn btn-primary">Add Region</a>
					<button type="button" class="btn btn-primary" onclick="editdata()">Edit Region</button>
					<button type="button" class="btn btn-primary" onclick="deletedata()">Delete Region</button>
